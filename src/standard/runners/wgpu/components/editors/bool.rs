...
use crate::standard::runners::winitwgpu::prelude::UI;
...
pub fn BoolEditBase<G>(state: Mutable<bool>) -> impl UI + Resizable
where
    G: BoolEditGraphics,
{
...
pub fn Switch(state: Mutable<bool>) -> impl UI {
    BoolEditBase::<AnimatedSwitch>(state).with_minimum_size(Extent2::new(32.0, 20.0))
}

/// Same as [Switch]
pub fn VerticalSwitch(state: Mutable<bool>) -> impl UI {
