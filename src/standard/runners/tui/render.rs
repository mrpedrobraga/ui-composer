...
pub trait Canvas {
    ...
    fn rect(&mut self, rect: Rect<f32, f32>, color: Self::Pixel) where Self::Pixel: Clone;
...
impl<P> Canvas for Framebuffer<P> where P: Default {
    type Pixel = P;
