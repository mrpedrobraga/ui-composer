...
pub trait Canvas {
    ...
    fn quad(&mut self, rect: Rect<f32, f32>, shader: impl Fn(PixelShaderInput) -> Self::Pixel);
}
...
impl TextModePixel {
    pub fn new(bg_color: Rgba<f32>, fg_color: Rgba<f32>, character: char) -> Self {
        Self { bg_color, fg_color, character }
    }
}
    ...
    fn quad(&mut self, rect: Rect<f32, f32>, shader: impl Fn(PixelShaderInput) -> Self::Pixel) {
        ...
        for y in y0 as u32..y1 as u32 {
            for x in x0 as u32..x1 as u32 {
                ...
                self.put_pixel(Vec2::new(x as u32, y as u32), shader(input));
            }
        }
    }
}
